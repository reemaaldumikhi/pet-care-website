  ...
  <div class="wrapper">
   ...
   <div class="main_content" class="container">
    <div class="maxwidth">
        ...
        $sql =  "SELECT * FROM petappointment WHERE status = 'accepted'";
        ...
        ?>
          ...
          <tr>
            ...
            <td style="width:20%">
              <i class="fa-solid fa-check-circle" style="transform:scale(1.5);cursor:pointer;" onclick="setStatus('<?php echo $row['pEmail'];?>','done')"></i>
            </td>
          <tr>
