<?php include_once ("petcarecontroller.php"); ?>
<!DOCTYPE html>
<html>
...
<body>
  ...
  <form class="forget-password-form" action="emailverification.php" method="post">


<h1>verify your email</h1>
<h2>please write the code that was sent to your email</h2>
...
<p><input type="text" name="otp" id="code" required></p>
