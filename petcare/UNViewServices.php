...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title></title>
    <link rel="stylesheet" href="/Users/noufalbatli/Desktop/381project/github/381project/381/homestyle.css">

    <link rel="stylesheet" href="/Users/noufalbatli/Desktop/381project/github/381project/381/style.css" type="text/css">
  ...
  <ul class="navbar-list">
     ...
     <li class="navbar-item" ><a  href="log in.php">Log in</a></li>
     <li class="navbar-item" ><a  href="register form.php">(New PetOwner?)</a></li>
  </ul>
  </div>
    </nav>
  </header>
    ...
    <div  class="container">
      ...
      <div class="content">
        ...
        ?>
                         <div class="service">
                             <div class="box">
                                 <div><img src="images/<?php echo $photo; ?>" alt="" /></div>
